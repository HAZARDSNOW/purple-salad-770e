...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-salad-770e
```

A live public deployment of this template is available at [https://purple-salad-770e.templates.workers.dev](https://purple-salad-770e.templates.workers.dev)
